function [ genuine_scores, SimilarityMatrix,count,imposter_scores, pointRank ] = prob_dist( weights_gallery, weights_probe, number_of_coeff , distMeasure )
...
if(strcmp(distMeasure,'euclidean'))
   subplot(4,3,1), plot(range,g_pdf , range,i_pdf); 
elseif(strcmp(distMeasure,'chebychev'))
   subplot(4,3,4), plot(range,g_pdf , range,i_pdf); 
elseif(strcmp(distMeasure,'minkowski'))
    subplot(4,3,7), plot(range,g_pdf , range,i_pdf);
elseif(strcmp(distMeasure,'cityblock'))
    subplot(4,3,10), plot(range,g_pdf , range,i_pdf);
end    
...
if(strcmp(distMeasure,'euclidean'))
   subplot(4,3,2), plot((1:1:100),pointRank); 
elseif(strcmp(distMeasure,'chebychev'))
   subplot(4,3,5), plot((1:1:100),pointRank); 
elseif(strcmp(distMeasure,'minkowski'))
    subplot(4,3,8), plot((1:1:100),pointRank);
elseif(strcmp(distMeasure,'cityblock'))
    subplot(4,3,11), plot((1:1:100),pointRank);
end  
...
if(strcmp(distMeasure,'euclidean'))
   subplot(4,3,3), plot(FMR,GMR); 
elseif(strcmp(distMeasure,'chebychev'))
   subplot(4,3,6), plot(FMR,GMR); 
elseif(strcmp(distMeasure,'minkowski'))
    subplot(4,3,9), plot(FMR,GMR);
elseif(strcmp(distMeasure,'cityblock'))
    subplot(4,3,12), plot(FMR,GMR);
end
